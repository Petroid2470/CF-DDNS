...
update_record() {
local ip_version="$1"; local ip="$2"; local last_ip="$3"; local record_id="$4"; local ip_type="$5"
...
update_record "IPV4" "$IPV4" "$LAST_IPV4" "$RECORD_ID_V4" "A" 
update_record "IPV6" "$IPV6" "$LAST_IPV6" "$RECORD_ID_V6" "AAAA" 
